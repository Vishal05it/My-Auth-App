...
function Login() {
  ...
  let { isLogin, setIsLogin, userToken, setUserToken, user, setUser } =
    useAllContexts();
  let loginFunc = async () => {
    try {
      setShowLoader(true);
  ...
  return (
    <>
      <div className="flex h-full dark:bg-gray-800 dark:text-gray-100 justify-center">
        <div
          className="w-full  max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-800 dark:text-gray-100"
          bis_skin_checked="1"
        >
