...
function Navbar() {
  ...
  return (
    <>
      <header className="p-4 relative dark:bg-gray-800 dark:text-gray-100">
        <div
        ...
        >
          <ul className="items-stretch hidden space-x-3 lg:flex">
            ...
            <li className="flex">
              <NavLink
                rel="noopener noreferrer"
                to="/about"
                className="flex items-center hover:text-violet-600 px-4 -mb-1 border-b-2 dark:border-"
              >
                About
              </NavLink>
            </li>
          ...
          <div className="flex items-center md:space-x-4" bis_skin_checked="1">
